# Amazon.SellingPartnerAPI.SDK.Api.sales.v1.SalesApi
...
try
{
    ApiResponse<GetOrderMetricsResponse> response = apiInstance.GetOrderMetricsWithHttpInfo(marketplaceIds, interval, granularity, granularityTimeZone, buyerType, fulfillmentNetwork, firstDayOfWeek, asin, sku);
