...
namespace Amazon.SellingPartnerAPI.SDK.Model.invoicing.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetInvoiceStatusResponse")]
    public partial class GetInvoiceStatusResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetInvoiceStatusResponse(ShipmentInvoiceStatusResponse payload = default(ShipmentInvoiceStatusResponse), List<Error> errors = default(List<Error>))
        {
