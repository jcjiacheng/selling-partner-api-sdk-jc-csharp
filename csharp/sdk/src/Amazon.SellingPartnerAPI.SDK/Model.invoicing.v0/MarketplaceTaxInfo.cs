...
namespace Amazon.SellingPartnerAPI.SDK.Model.invoicing.v0
{
    ...
    public partial class MarketplaceTaxInfo : IValidatableObject
    {
        ...
        /// <param name="taxClassifications">The list of tax classifications..</param>
        public MarketplaceTaxInfo(string companyLegalName = default(string), string taxingRegion = default(string), List<TaxClassification> taxClassifications = default(List<TaxClassification>))
        {
        ...
        /// </summary>
        /// <value>The list of tax classifications.</value>
