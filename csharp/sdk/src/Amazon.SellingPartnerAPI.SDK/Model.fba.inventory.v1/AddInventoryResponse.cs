...
namespace Amazon.SellingPartnerAPI.SDK.Model.fba.inventory.v1
{
    ...
    /// </summary>
    [DataContract(Name = "AddInventoryResponse")]
    public partial class AddInventoryResponse : IValidatableObject
    {
        /// <summary>
        ...
        public AddInventoryResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
