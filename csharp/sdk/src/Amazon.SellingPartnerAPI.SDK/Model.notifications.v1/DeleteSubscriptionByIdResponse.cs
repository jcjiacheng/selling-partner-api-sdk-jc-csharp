...
namespace Amazon.SellingPartnerAPI.SDK.Model.notifications.v1
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteSubscriptionByIdResponse")]
    public partial class DeleteSubscriptionByIdResponse : IValidatableObject
    {
        /// <summary>
        ...
        public DeleteSubscriptionByIdResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
