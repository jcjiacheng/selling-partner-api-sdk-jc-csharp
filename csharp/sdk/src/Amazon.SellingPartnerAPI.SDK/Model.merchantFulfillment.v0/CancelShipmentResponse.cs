...
namespace Amazon.SellingPartnerAPI.SDK.Model.merchantFulfillment.v0
{
    ...
    /// Response schema.
    /// </summary>
    [DataContract(Name = "CancelShipmentResponse")]
    public partial class CancelShipmentResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CancelShipmentResponse(Shipment payload = default(Shipment), List<Error> errors = default(List<Error>))
        {
