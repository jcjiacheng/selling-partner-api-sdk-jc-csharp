...
namespace Amazon.SellingPartnerAPI.SDK.Model.merchantFulfillment.v0
{
    ...
    /// Response schema.
    /// </summary>
    [DataContract(Name = "CreateShipmentResponse")]
    public partial class CreateShipmentResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateShipmentResponse(Shipment payload = default(Shipment), List<Error> errors = default(List<Error>))
        {
