...
namespace Amazon.SellingPartnerAPI.SDK.Model.vendor.orders.v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetPurchaseOrderResponse")]
    public partial class GetPurchaseOrderResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPurchaseOrderResponse" /> class.
        /// </summary>
        /// <param name="payload">payload.</param>
        /// <param name="errors">A list of error responses returned when a request is unsuccessful..</param>
        public GetPurchaseOrderResponse(Order payload = default(Order), List<Error> errors = default(List<Error>))
        {
