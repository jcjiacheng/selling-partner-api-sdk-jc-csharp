...
namespace Amazon.SellingPartnerAPI.SDK.Model.pricing.v2022_05_01
{
    ...
    /// </summary>
    [DataContract(Name = "FeaturedOfferExpectedPriceResponse")]
    public partial class FeaturedOfferExpectedPriceResponse : IValidatableObject
    {
        /// <summary>
        ...
        public FeaturedOfferExpectedPriceResponse(Dictionary<string, string> headers = default(Dictionary<string, string>), HttpStatusLine status = default(HttpStatusLine), FeaturedOfferExpectedPriceRequestParams request = default(FeaturedOfferExpectedPriceRequestParams), FeaturedOfferExpectedPriceResponseBody body = default(FeaturedOfferExpectedPriceResponseBody))
        {
            ...
            if (headers == null)
            {
                throw new ArgumentNullException("headers is a required property for FeaturedOfferExpectedPriceResponse and cannot be null");
            }
            this.Headers = headers;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for FeaturedOfferExpectedPriceResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "request" is required (not null)
            if (request == null)
            {
                throw new ArgumentNullException("request is a required property for FeaturedOfferExpectedPriceResponse and cannot be null");
            }
