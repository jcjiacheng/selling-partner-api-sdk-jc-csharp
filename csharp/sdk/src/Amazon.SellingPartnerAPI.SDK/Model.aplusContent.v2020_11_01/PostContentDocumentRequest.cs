...
namespace Amazon.SellingPartnerAPI.SDK.Model.aplusContent.v2020_11_01
{
    ...
    /// </summary>
    [DataContract(Name = "PostContentDocumentRequest")]
    public partial class PostContentDocumentRequest : IValidatableObject
    {
        /// <summary>
        ...
        public PostContentDocumentRequest(ContentDocument contentDocument = default(ContentDocument))
        {
            ...
            {
                throw new ArgumentNullException("contentDocument is a required property for PostContentDocumentRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "contentDocument", IsRequired = true, EmitDefaultValue = true)]
