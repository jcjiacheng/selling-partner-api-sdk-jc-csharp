...
namespace Amazon.SellingPartnerAPI.SDK.Model.aplusContent.v2020_11_01
{
    ...
    /// </summary>
    [DataContract(Name = "GetContentDocumentResponse")]
    public partial class GetContentDocumentResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetContentDocumentResponse(List<Error> warnings = default(List<Error>), ContentRecord contentRecord = default(ContentRecord))
        {
            ...
            {
                throw new ArgumentNullException("contentRecord is a required property for GetContentDocumentResponse and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "contentRecord", IsRequired = true, EmitDefaultValue = true)]
