...
namespace Amazon.SellingPartnerAPI.SDK.Model.shipping.v2
{
    ...
    /// </summary>
    [DataContract(Name = "UnlinkCarrierAccountResponse")]
    public partial class UnlinkCarrierAccountResponse : IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsUnlinked: ").Append(IsUnlinked).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
