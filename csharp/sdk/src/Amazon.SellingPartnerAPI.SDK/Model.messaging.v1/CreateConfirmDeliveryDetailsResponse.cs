...
namespace Amazon.SellingPartnerAPI.SDK.Model.messaging.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateConfirmDeliveryDetailsResponse")]
    public partial class CreateConfirmDeliveryDetailsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateConfirmDeliveryDetailsResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
