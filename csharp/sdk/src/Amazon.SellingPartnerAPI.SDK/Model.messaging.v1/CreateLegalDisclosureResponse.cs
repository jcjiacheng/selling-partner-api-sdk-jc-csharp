...
namespace Amazon.SellingPartnerAPI.SDK.Model.messaging.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateLegalDisclosureResponse")]
    public partial class CreateLegalDisclosureResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateLegalDisclosureResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
