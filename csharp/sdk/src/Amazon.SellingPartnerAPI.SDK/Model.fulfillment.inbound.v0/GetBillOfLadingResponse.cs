...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetBillOfLadingResponse")]
    public partial class GetBillOfLadingResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetBillOfLadingResponse(BillOfLadingDownloadURL payload = default(BillOfLadingDownloadURL), List<Error> errors = default(List<Error>))
        {
