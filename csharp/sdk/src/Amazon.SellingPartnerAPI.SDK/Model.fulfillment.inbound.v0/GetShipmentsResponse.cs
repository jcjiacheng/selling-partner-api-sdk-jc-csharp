...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetShipmentsResponse")]
    public partial class GetShipmentsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetShipmentsResponse(GetShipmentsResult payload = default(GetShipmentsResult), List<Error> errors = default(List<Error>))
        {
