...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetPrepInstructionsResponse")]
    public partial class GetPrepInstructionsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetPrepInstructionsResponse(GetPrepInstructionsResult payload = default(GetPrepInstructionsResult), List<Error> errors = default(List<Error>))
        {
