...
namespace Amazon.SellingPartnerAPI.SDK.Model.solicitations.v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetSolicitationActionsForOrderResponse__embedded")]
    public partial class GetSolicitationActionsForOrderResponseEmbedded : IValidatableObject
    {
        /// <summary>
        ...
        public GetSolicitationActionsForOrderResponseEmbedded(List<GetSolicitationActionResponse> actions = default(List<GetSolicitationActionResponse>))
        {
            ...
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for GetSolicitationActionsForOrderResponseEmbedded and cannot be null");
            }
