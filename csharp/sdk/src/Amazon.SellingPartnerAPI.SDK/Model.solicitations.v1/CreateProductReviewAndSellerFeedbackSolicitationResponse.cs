...
namespace Amazon.SellingPartnerAPI.SDK.Model.solicitations.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateProductReviewAndSellerFeedbackSolicitationResponse")]
    public partial class CreateProductReviewAndSellerFeedbackSolicitationResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateProductReviewAndSellerFeedbackSolicitationResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
