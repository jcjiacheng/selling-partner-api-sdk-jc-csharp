...
namespace Amazon.SellingPartnerAPI.SDK.Model.vendor.shipments.v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetShipmentDetailsResponse")]
    public partial class GetShipmentDetailsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetShipmentDetailsResponse(ShipmentDetails payload = default(ShipmentDetails), List<Error> errors = default(List<Error>))
        {
