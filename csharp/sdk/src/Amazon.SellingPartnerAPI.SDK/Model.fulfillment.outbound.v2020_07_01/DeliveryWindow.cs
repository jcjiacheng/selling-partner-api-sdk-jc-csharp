...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.outbound.v2020_07_01
{
    ...
    /// </summary>
    [DataContract(Name = "DeliveryWindow")]
    public partial class DeliveryWindow : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="DeliveryWindow" /> class.
        /// </summary>
        /// <param name="startDate">Date timestamp (required).</param>
        /// <param name="endDate">Date timestamp (required).</param>
