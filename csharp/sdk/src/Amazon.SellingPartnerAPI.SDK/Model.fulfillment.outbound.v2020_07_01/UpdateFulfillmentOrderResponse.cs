...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.outbound.v2020_07_01
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateFulfillmentOrderResponse")]
    public partial class UpdateFulfillmentOrderResponse : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateFulfillmentOrderResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
