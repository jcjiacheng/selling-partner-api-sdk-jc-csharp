...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.outbound.v2020_07_01
{
    ...
    /// </summary>
    [DataContract(Name = "CancelFulfillmentOrderResponse")]
    public partial class CancelFulfillmentOrderResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CancelFulfillmentOrderResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
