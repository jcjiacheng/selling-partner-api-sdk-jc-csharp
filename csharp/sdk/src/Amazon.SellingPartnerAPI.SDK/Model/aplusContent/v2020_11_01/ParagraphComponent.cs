...
namespace Amazon.SellingPartnerAPI.SDK.Model/aplusContent/v2020_11_01
{
    ...
    /// </summary>
    [DataContract(Name = "ParagraphComponent")]
    public partial class ParagraphComponent : IValidatableObject
    {
        /// <summary>
        ...
        public ParagraphComponent(List<TextComponent> textList = default(List<TextComponent>))
        {
            ...
            if (textList == null)
            {
                throw new ArgumentNullException("textList is a required property for ParagraphComponent and cannot be null");
            }
