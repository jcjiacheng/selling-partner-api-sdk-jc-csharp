...
namespace Amazon.SellingPartnerAPI.SDK.Model/orders/v0
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateShipmentStatusErrorResponse")]
    public partial class UpdateShipmentStatusErrorResponse : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateShipmentStatusErrorResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
