...
namespace Amazon.SellingPartnerAPI.SDK.Model/vendor/orders/v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetPurchaseOrdersStatusResponse")]
    public partial class GetPurchaseOrdersStatusResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetPurchaseOrdersStatusResponse(OrderListStatus payload = default(OrderListStatus), List<Error> errors = default(List<Error>))
        {
