...
namespace Amazon.SellingPartnerAPI.SDK.Model/awd/v2024_05_09
{
    ...
    /// </summary>
    [DataContract(Name = "SkuEligibility")]
    public partial class SkuEligibility : IValidatableObject
    {
        ...
        public SkuEligibility(List<SkuIneligibilityReason> ineligibilityReasons = default(List<SkuIneligibilityReason>), DistributionPackageQuantity packageQuantity = default(DistributionPackageQuantity), InboundEligibilityStatus status = default(InboundEligibilityStatus))
        {
            ...
            {
                throw new ArgumentNullException("packageQuantity is a required property for SkuEligibility and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "packageQuantity", IsRequired = true, EmitDefaultValue = true)]
