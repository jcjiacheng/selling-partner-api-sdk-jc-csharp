...
namespace Amazon.SellingPartnerAPI.SDK.Model/merchantFulfillment/v0
{
    ...
    /// </summary>
    [DataContract(Name = "TemporarilyUnavailableCarrier")]
    public partial class TemporarilyUnavailableCarrier : IValidatableObject
    {
        /// <summary>
        ...
        public TemporarilyUnavailableCarrier(string carrierName = default(string))
        {
            ...
            if (carrierName == null)
            {
                throw new ArgumentNullException("carrierName is a required property for TemporarilyUnavailableCarrier and cannot be null");
            }
