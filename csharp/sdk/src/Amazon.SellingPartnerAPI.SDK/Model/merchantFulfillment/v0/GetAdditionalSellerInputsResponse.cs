...
namespace Amazon.SellingPartnerAPI.SDK.Model/merchantFulfillment/v0
{
    ...
    /// Response schema.
    /// </summary>
    [DataContract(Name = "GetAdditionalSellerInputsResponse")]
    public partial class GetAdditionalSellerInputsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetAdditionalSellerInputsResponse(GetAdditionalSellerInputsResult payload = default(GetAdditionalSellerInputsResult), List<Error> errors = default(List<Error>))
        {
