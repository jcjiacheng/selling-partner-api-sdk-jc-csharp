...
namespace Amazon.SellingPartnerAPI.SDK.Model/solicitations/v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetSolicitationActionsForOrderResponse")]
    public partial class GetSolicitationActionsForOrderResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetSolicitationActionsForOrderResponse(GetSolicitationActionsForOrderResponseLinks links = default(GetSolicitationActionsForOrderResponseLinks), GetSolicitationActionsForOrderResponseEmbedded embedded = default(GetSolicitationActionsForOrderResponseEmbedded), List<Error> errors = default(List<Error>))
        {
            this.Links = links;
