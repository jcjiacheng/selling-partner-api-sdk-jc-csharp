...
namespace Amazon.SellingPartnerAPI.SDK.Model/notifications/v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDestinationResponse")]
    public partial class CreateDestinationResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateDestinationResponse(Destination payload = default(Destination), List<Error> errors = default(List<Error>))
        {
