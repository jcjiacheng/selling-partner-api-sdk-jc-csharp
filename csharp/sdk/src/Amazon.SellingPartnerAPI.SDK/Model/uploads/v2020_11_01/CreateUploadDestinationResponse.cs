...
namespace Amazon.SellingPartnerAPI.SDK.Model/uploads/v2020_11_01
{
    /// <summary>
    /// The response schema for the createUploadDestination operation.
    /// </summary>
    [DataContract(Name = "CreateUploadDestinationResponse")]
    public partial class CreateUploadDestinationResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateUploadDestinationResponse(UploadDestination payload = default(UploadDestination), List<Error> errors = default(List<Error>))
        {
