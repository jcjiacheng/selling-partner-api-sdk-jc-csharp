...
namespace Amazon.SellingPartnerAPI.SDK.Model/fba/eligibility/v1
{
    /// <summary>
    ...
    /// </summary>
    [DataContract(Name = "ItemEligibilityPreview")]
    public partial class ItemEligibilityPreview : IValidatableObject
    {
        /// <summary>
        ...
        public ItemEligibilityPreview(string asin = default(string), string marketplaceId = default(string), ProgramEnum program = default(ProgramEnum), bool isEligibleForProgram = default(bool), List<IneligibilityReasonListEnum> ineligibilityReasonList = default(List<IneligibilityReasonListEnum>))
        {
            ...
            if (asin == null)
            {
                throw new ArgumentNullException("asin is a required property for ItemEligibilityPreview and cannot be null");
            }
            this.Asin = asin;
        ...
        [DataMember(Name = "isEligibleForProgram", IsRequired = true, EmitDefaultValue = true)]
