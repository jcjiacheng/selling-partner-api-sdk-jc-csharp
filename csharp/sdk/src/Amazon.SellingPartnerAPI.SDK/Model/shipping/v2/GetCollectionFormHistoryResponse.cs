...
namespace Amazon.SellingPartnerAPI.SDK.Model/shipping/v2
{
    ...
    /// </summary>
    [DataContract(Name = "GetCollectionFormHistoryResponse")]
    public partial class GetCollectionFormHistoryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCollectionFormHistoryResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CollectionFormsHistoryRecordList: ").Append(CollectionFormsHistoryRecordList).Append("\n");
            sb.Append("  LastRefreshedDate: ").Append(LastRefreshedDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
