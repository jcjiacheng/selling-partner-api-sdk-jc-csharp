...
namespace Amazon.SellingPartnerAPI.SDK.Model/services/v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetServiceJobsResponse")]
    public partial class GetServiceJobsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetServiceJobsResponse(JobListing payload = default(JobListing), List<Error> errors = default(List<Error>))
        {
