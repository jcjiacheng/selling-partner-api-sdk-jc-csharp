...
namespace Amazon.SellingPartnerAPI.SDK.Model/services/v1
{
    ...
    /// </summary>
    [DataContract(Name = "AddAppointmentRequest")]
    public partial class AddAppointmentRequest : IValidatableObject
    {
        /// <summary>
        ...
        public AddAppointmentRequest(AppointmentTimeInput appointmentTime = default(AppointmentTimeInput))
        {
            ...
            {
                throw new ArgumentNullException("appointmentTime is a required property for AddAppointmentRequest and cannot be null");
            }
