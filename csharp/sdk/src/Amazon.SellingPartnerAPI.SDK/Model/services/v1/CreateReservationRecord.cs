...
namespace Amazon.SellingPartnerAPI.SDK.Model/services/v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateReservationRecord")]
    public partial class CreateReservationRecord : IValidatableObject
    {
        /// <summary>
        ...
        public CreateReservationRecord(Reservation reservation = default(Reservation), List<Warning> warnings = default(List<Warning>), List<Error> errors = default(List<Error>))
        {
