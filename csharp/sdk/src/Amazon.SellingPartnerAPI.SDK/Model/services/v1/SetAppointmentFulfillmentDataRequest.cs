...
namespace Amazon.SellingPartnerAPI.SDK.Model/services/v1
{
    ...
    public partial class SetAppointmentFulfillmentDataRequest : IValidatableObject
    {
        ...
        public SetAppointmentFulfillmentDataRequest(FulfillmentTime fulfillmentTime = default(FulfillmentTime), List<AppointmentResource> appointmentResources = default(List<AppointmentResource>), List<FulfillmentDocument> fulfillmentDocuments = default(List<FulfillmentDocument>))
        {
