...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/outbound/v2020_07_01
{
    ...
    public partial class Money : IValidatableObject
    {
        ...
        public Money(string currencyCode = default(string), string value = default(string))
        {
            ...
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for Money and cannot be null");
            }
            this.Value = value;
        }
