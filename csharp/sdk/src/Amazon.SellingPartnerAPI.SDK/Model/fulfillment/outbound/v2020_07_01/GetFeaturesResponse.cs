...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/outbound/v2020_07_01
{
    ...
    /// </summary>
    [DataContract(Name = "GetFeaturesResponse")]
    public partial class GetFeaturesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetFeaturesResponse(GetFeaturesResult payload = default(GetFeaturesResult), List<Error> errors = default(List<Error>))
        {
