...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/outbound/v2020_07_01
{
    ...
    /// </summary>
    [DataContract(Name = "CreateFulfillmentReturnResponse")]
    public partial class CreateFulfillmentReturnResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateFulfillmentReturnResponse(CreateFulfillmentReturnResult payload = default(CreateFulfillmentReturnResult), List<Error> errors = default(List<Error>))
        {
