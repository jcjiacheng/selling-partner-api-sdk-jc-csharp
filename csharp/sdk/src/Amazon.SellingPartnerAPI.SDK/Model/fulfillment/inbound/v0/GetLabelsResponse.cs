...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/inbound/v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetLabelsResponse")]
    public partial class GetLabelsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetLabelsResponse(LabelDownloadURL payload = default(LabelDownloadURL), List<Error> errors = default(List<Error>))
        {
