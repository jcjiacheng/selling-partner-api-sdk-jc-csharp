...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/inbound/v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateDeliveryWindowOptionsResponse")]
    public partial class GenerateDeliveryWindowOptionsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDeliveryWindowOptionsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateDeliveryWindowOptionsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDeliveryWindowOptionsResponse" /> class.
        /// </summary>
        ...
        public GenerateDeliveryWindowOptionsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for GenerateDeliveryWindowOptionsResponse and cannot be null");
            }
