...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/inbound/v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateShipmentContentUpdatePreviewsResponse")]
    public partial class GenerateShipmentContentUpdatePreviewsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GenerateShipmentContentUpdatePreviewsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for GenerateShipmentContentUpdatePreviewsResponse and cannot be null");
            }
