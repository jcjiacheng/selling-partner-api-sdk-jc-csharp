...
namespace Amazon.SellingPartnerAPI.SDK.Model/fulfillment/inbound/v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "ListPackingGroupBoxesResponse")]
    public partial class ListPackingGroupBoxesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ListPackingGroupBoxesResponse(List<Box> boxes = default(List<Box>), Pagination pagination = default(Pagination))
        {
            ...
            if (boxes == null)
            {
                throw new ArgumentNullException("boxes is a required property for ListPackingGroupBoxesResponse and cannot be null");
            }
            this.Boxes = boxes;
