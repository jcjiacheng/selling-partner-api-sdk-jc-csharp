...
namespace Amazon.SellingPartnerAPI.SDK.Model/messaging/v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateWarrantyResponse")]
    public partial class CreateWarrantyResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateWarrantyResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
