...
namespace Amazon.SellingPartnerAPI.SDK.Model/messaging/v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetMessagingActionsForOrderResponse__embedded")]
    public partial class GetMessagingActionsForOrderResponseEmbedded : IValidatableObject
    {
        /// <summary>
        ...
        public GetMessagingActionsForOrderResponseEmbedded(List<GetMessagingActionResponse> actions = default(List<GetMessagingActionResponse>))
        {
            ...
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for GetMessagingActionsForOrderResponseEmbedded and cannot be null");
            }
