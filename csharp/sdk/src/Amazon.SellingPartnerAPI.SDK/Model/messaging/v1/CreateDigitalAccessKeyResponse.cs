...
namespace Amazon.SellingPartnerAPI.SDK.Model/messaging/v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDigitalAccessKeyResponse")]
    public partial class CreateDigitalAccessKeyResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateDigitalAccessKeyResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
