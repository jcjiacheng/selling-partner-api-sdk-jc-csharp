...
namespace Amazon.SellingPartnerAPI.SDK.Model/messaging/v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetMessagingActionsForOrderResponse__links")]
    public partial class GetMessagingActionsForOrderResponseLinks : IValidatableObject
    {
        /// <summary>
        ...
        public GetMessagingActionsForOrderResponseLinks(LinkObject self = default(LinkObject), List<LinkObject> actions = default(List<LinkObject>))
        {
            ...
            if (self == null)
            {
                throw new ArgumentNullException("self is a required property for GetMessagingActionsForOrderResponseLinks and cannot be null");
            }
            this.Self = self;
            // to ensure "actions" is required (not null)
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for GetMessagingActionsForOrderResponseLinks and cannot be null");
            }
