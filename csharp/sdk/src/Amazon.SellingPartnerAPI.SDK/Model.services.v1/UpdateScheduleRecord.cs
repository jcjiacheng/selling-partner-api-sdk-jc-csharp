...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateScheduleRecord")]
    public partial class UpdateScheduleRecord : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateScheduleRecord(AvailabilityRecord availability = default(AvailabilityRecord), List<Warning> warnings = default(List<Warning>), List<Error> errors = default(List<Error>))
        {
