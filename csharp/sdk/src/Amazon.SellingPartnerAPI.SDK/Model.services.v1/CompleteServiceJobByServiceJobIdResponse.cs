...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CompleteServiceJobByServiceJobIdResponse")]
    public partial class CompleteServiceJobByServiceJobIdResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CompleteServiceJobByServiceJobIdResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
