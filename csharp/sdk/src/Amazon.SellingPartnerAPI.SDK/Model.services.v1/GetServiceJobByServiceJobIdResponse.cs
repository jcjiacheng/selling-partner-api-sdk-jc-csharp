...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "GetServiceJobByServiceJobIdResponse")]
    public partial class GetServiceJobByServiceJobIdResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetServiceJobByServiceJobIdResponse(ServiceJob payload = default(ServiceJob), List<Error> errors = default(List<Error>))
        {
