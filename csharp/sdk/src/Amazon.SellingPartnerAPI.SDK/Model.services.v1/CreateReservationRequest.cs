...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateReservationRequest")]
    public partial class CreateReservationRequest : IValidatableObject
    {
        /// <summary>
        ...
        public CreateReservationRequest(string resourceId = default(string), Reservation reservation = default(Reservation))
        {
            ...
            if (resourceId == null)
            {
                throw new ArgumentNullException("resourceId is a required property for CreateReservationRequest and cannot be null");
            }
            this.ResourceId = resourceId;
            // to ensure "reservation" is required (not null)
            if (reservation == null)
            {
                throw new ArgumentNullException("reservation is a required property for CreateReservationRequest and cannot be null");
            }
