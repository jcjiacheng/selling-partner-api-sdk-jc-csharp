...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CancelReservationResponse")]
    public partial class CancelReservationResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CancelReservationResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
