...
namespace Amazon.SellingPartnerAPI.SDK.Model.services.v1
{
    ...
    /// </summary>
    [DataContract(Name = "CreateReservationResponse")]
    public partial class CreateReservationResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateReservationResponse(CreateReservationRecord payload = default(CreateReservationRecord), List<Error> errors = default(List<Error>))
        {
        ...
        public CreateReservationRecord Payload { get; set; }
