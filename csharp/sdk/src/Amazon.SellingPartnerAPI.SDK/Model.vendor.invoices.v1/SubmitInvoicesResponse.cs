...
namespace Amazon.SellingPartnerAPI.SDK.Model.vendor.invoices.v1
{
    ...
    /// </summary>
    [DataContract(Name = "SubmitInvoicesResponse")]
    public partial class SubmitInvoicesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public SubmitInvoicesResponse(TransactionId payload = default(TransactionId), List<Error> errors = default(List<Error>))
        {
