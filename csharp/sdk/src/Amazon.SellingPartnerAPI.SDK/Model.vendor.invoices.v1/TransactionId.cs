...
namespace Amazon.SellingPartnerAPI.SDK.Model.vendor.invoices.v1
{
    ...
    public partial class TransactionId : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varTransactionId">GUID to identify this transaction. This value can be used with the Transaction Status API to return the status of this transaction..</param>
