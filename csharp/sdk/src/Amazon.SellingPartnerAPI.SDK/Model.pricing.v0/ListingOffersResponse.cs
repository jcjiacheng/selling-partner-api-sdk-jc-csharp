...
namespace Amazon.SellingPartnerAPI.SDK.Model.pricing.v0
{
    ...
    /// </summary>
    [DataContract(Name = "ListingOffersResponse")]
    public partial class ListingOffersResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ListingOffersResponse(HttpResponseHeaders headers = default(HttpResponseHeaders), GetOffersHttpStatusLine status = default(GetOffersHttpStatusLine), GetOffersResponse body = default(GetOffersResponse), ListingOffersRequestParams request = default(ListingOffersRequestParams))
        {
            ...
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for ListingOffersResponse and cannot be null");
            }
            this.Body = body;
