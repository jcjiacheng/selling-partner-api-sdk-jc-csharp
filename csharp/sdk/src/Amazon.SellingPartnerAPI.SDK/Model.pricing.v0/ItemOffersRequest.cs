...
namespace Amazon.SellingPartnerAPI.SDK.Model.pricing.v0
{
    ...
    /// </summary>
    [DataContract(Name = "ItemOffersRequest")]
    public partial class ItemOffersRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemOffersRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemOffersRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemOffersRequest" /> class.
        /// </summary>
        ...
        public ItemOffersRequest(string uri = default(string), HttpMethod method = default(HttpMethod), Dictionary<string, string> headers = default(Dictionary<string, string>), string marketplaceId = default(string), ItemCondition itemCondition = default(ItemCondition), CustomerType? customerType = default(CustomerType?))
        {
            // to ensure "uri" is required (not null)
            if (uri == null)
            {
                throw new ArgumentNullException("uri is a required property for ItemOffersRequest and cannot be null");
            }
            this.Uri = uri;
            this.Method = method;
            ...
            {
                throw new ArgumentNullException("marketplaceId is a required property for ItemOffersRequest and cannot be null");
            }
