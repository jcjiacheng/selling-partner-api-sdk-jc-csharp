...
namespace Amazon.SellingPartnerAPI.SDK.Model.pricing.v0
{
    ...
    /// </summary>
    [DataContract(Name = "LowestPriceType")]
    public partial class LowestPriceType : IValidatableObject
    {
        ...
        public LowestPriceType(string condition = default(string), string fulfillmentChannel = default(string), OfferCustomerType? offerType = default(OfferCustomerType?), int quantityTier = default(int), QuantityDiscountType? quantityDiscountType = default(QuantityDiscountType?), MoneyType landedPrice = default(MoneyType), MoneyType listingPrice = default(MoneyType), MoneyType shipping = default(MoneyType), Points points = default(Points))
        {
            ...
            if (condition == null)
            {
                throw new ArgumentNullException("condition is a required property for LowestPriceType and cannot be null");
            }
            this.Condition = condition;
            // to ensure "fulfillmentChannel" is required (not null)
            if (fulfillmentChannel == null)
            {
                throw new ArgumentNullException("fulfillmentChannel is a required property for LowestPriceType and cannot be null");
            }
            this.FulfillmentChannel = fulfillmentChannel;
            // to ensure "listingPrice" is required (not null)
            if (listingPrice == null)
            {
                throw new ArgumentNullException("listingPrice is a required property for LowestPriceType and cannot be null");
            }
