...
namespace Amazon.SellingPartnerAPI.SDK.Model.orders.v0
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateVerificationStatusRequest")]
    public partial class UpdateVerificationStatusRequest : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateVerificationStatusRequest(UpdateVerificationStatusRequestBody regulatedOrderVerificationStatus = default(UpdateVerificationStatusRequestBody))
        {
            ...
            {
                throw new ArgumentNullException("regulatedOrderVerificationStatus is a required property for UpdateVerificationStatusRequest and cannot be null");
            }
