...
namespace Amazon.SellingPartnerAPI.SDK.Model.orders.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetOrderAddressResponse")]
    public partial class GetOrderAddressResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetOrderAddressResponse(OrderAddress payload = default(OrderAddress), List<Error> errors = default(List<Error>))
        {
