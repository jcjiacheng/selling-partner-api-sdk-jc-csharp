...
namespace Amazon.SellingPartnerAPI.SDK.Model.orders.v0
{
    ...
    /// </summary>
    [DataContract(Name = "ConfirmShipmentErrorResponse")]
    public partial class ConfirmShipmentErrorResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ConfirmShipmentErrorResponse(List<Error> errors = default(List<Error>))
        {
            this.Errors = errors;
        }
