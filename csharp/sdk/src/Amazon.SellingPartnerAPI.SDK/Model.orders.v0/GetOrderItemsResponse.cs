...
namespace Amazon.SellingPartnerAPI.SDK.Model.orders.v0
{
    ...
    /// </summary>
    [DataContract(Name = "GetOrderItemsResponse")]
    public partial class GetOrderItemsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetOrderItemsResponse(OrderItemsList payload = default(OrderItemsList), List<Error> errors = default(List<Error>))
        {
