...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateShipmentNameRequest")]
    public partial class UpdateShipmentNameRequest : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateShipmentNameRequest(string name = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateShipmentNameRequest and cannot be null");
            }
            this.Name = name;
        }
