...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "ConfirmDeliveryWindowOptionsResponse")]
    public partial class ConfirmDeliveryWindowOptionsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmDeliveryWindowOptionsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConfirmDeliveryWindowOptionsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmDeliveryWindowOptionsResponse" /> class.
        /// </summary>
        ...
        public ConfirmDeliveryWindowOptionsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for ConfirmDeliveryWindowOptionsResponse and cannot be null");
            }
