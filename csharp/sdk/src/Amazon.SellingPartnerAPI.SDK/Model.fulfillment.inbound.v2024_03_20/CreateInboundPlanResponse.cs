...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "CreateInboundPlanResponse")]
    public partial class CreateInboundPlanResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CreateInboundPlanResponse(string inboundPlanId = default(string), string operationId = default(string))
        {
            ...
            {
                throw new ArgumentNullException("inboundPlanId is a required property for CreateInboundPlanResponse and cannot be null");
            }
            this.InboundPlanId = inboundPlanId;
            // to ensure "operationId" is required (not null)
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for CreateInboundPlanResponse and cannot be null");
            }
