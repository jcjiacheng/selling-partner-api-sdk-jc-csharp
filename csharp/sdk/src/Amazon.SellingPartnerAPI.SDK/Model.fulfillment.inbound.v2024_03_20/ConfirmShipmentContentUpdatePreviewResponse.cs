...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "ConfirmShipmentContentUpdatePreviewResponse")]
    public partial class ConfirmShipmentContentUpdatePreviewResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmShipmentContentUpdatePreviewResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConfirmShipmentContentUpdatePreviewResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmShipmentContentUpdatePreviewResponse" /> class.
        /// </summary>
        ...
        public ConfirmShipmentContentUpdatePreviewResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for ConfirmShipmentContentUpdatePreviewResponse and cannot be null");
            }
