...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "ListShipmentBoxesResponse")]
    public partial class ListShipmentBoxesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ListShipmentBoxesResponse(List<Box> boxes = default(List<Box>), Pagination pagination = default(Pagination))
        {
            ...
            if (boxes == null)
            {
                throw new ArgumentNullException("boxes is a required property for ListShipmentBoxesResponse and cannot be null");
            }
            this.Boxes = boxes;
