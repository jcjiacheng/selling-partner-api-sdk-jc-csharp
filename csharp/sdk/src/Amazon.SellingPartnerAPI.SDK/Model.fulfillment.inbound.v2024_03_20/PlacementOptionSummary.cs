...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "PlacementOptionSummary")]
    public partial class PlacementOptionSummary : IValidatableObject
    {
        /// <summary>
        ...
        public PlacementOptionSummary(string placementOptionId = default(string), string status = default(string))
        {
            ...
            {
                throw new ArgumentNullException("placementOptionId is a required property for PlacementOptionSummary and cannot be null");
            }
            this.PlacementOptionId = placementOptionId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for PlacementOptionSummary and cannot be null");
            }
            this.Status = status;
        }
