...
namespace Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v2024_03_20
{
    ...
    /// </summary>
    [DataContract(Name = "SetPrepDetailsResponse")]
    public partial class SetPrepDetailsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPrepDetailsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetPrepDetailsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPrepDetailsResponse" /> class.
        /// </summary>
        ...
        public SetPrepDetailsResponse(string operationId = default(string))
        {
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for SetPrepDetailsResponse and cannot be null");
            }
