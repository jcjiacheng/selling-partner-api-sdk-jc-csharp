...
namespace Amazon.SellingPartnerAPI.SDK.Api/easyship/v2022_03_23
{
    /// <summary>
    ...
    public interface IEasyShipApi : IApiAccessor
    {
        ...
        /// <returns>Package</returns>
        Package GetScheduledPackage (string amazonOrderIdstring marketplaceId);
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>ApiResponse of Package</returns>
        ApiResponse<Package> GetScheduledPackageWithHttpInfo (string amazonOrderIdstring marketplaceId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>Task of Package</returns>
        System.Threading.Tasks.Task<Package> GetScheduledPackageAsync (string amazonOrderIdstring marketplaceId);
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>Task of ApiResponse (Package)</returns>
        System.Threading.Tasks.Task<ApiResponse<Package>> GetScheduledPackageAsyncWithHttpInfo (string amazonOrderIdstring marketplaceId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class EasyShipApi : IEasyShipApi
    {
        ...
        /// <returns></returns>
        public EasyShipApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>Package</returns>
        public Package GetScheduledPackage (string amazonOrderIdstring marketplaceId)
        {
             ApiResponse<Package> localVarResponse = GetScheduledPackageWithHttpInfo(amazonOrderIdmarketplaceId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>ApiResponse of Package</returns>
        public ApiResponse< Package > GetScheduledPackageWithHttpInfo (string amazonOrderIdstring marketplaceId)
        {
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>Task of Package</returns>
        public async System.Threading.Tasks.Task<Package> GetScheduledPackageAsync (string amazonOrderIdstring marketplaceId)
        {
             ApiResponse<Package> localVarResponse = await GetScheduledPackageAsyncWithHttpInfo(amazonOrderIdmarketplaceId);
             return localVarResponse.Data;
        ...
        /// <param name="marketplaceId">An identifier for the marketplace in which the seller is selling.</param>
        /// <returns>Task of ApiResponse (Package)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Package>> GetScheduledPackageAsyncWithHttpInfo (string amazonOrderIdstring marketplaceId)
        {
            // verify the required parameter 'amazonOrderId' is set
            if (amazonOrderId == null)
                throw new ApiException(400, "Missing required parameter 'amazonOrderId' when calling EasyShipApi->GetScheduledPackage");
