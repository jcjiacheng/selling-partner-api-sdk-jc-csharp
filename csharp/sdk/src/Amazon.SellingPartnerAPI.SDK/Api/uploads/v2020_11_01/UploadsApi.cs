...
namespace Amazon.SellingPartnerAPI.SDK.Api/uploads/v2020_11_01
{
    /// <summary>
    ...
    public interface IUploadsApi : IApiAccessor
    {
        ...
        CreateUploadDestinationResponse CreateUploadDestinationForResource (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null);
        ...
        ApiResponse<CreateUploadDestinationResponse> CreateUploadDestinationForResourceWithHttpInfo (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null);
        ...
        System.Threading.Tasks.Task<CreateUploadDestinationResponse> CreateUploadDestinationForResourceAsync (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateUploadDestinationResponse>> CreateUploadDestinationForResourceAsyncWithHttpInfo (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null);
    ...
    public partial class UploadsApi : IUploadsApi
    {
        ...
        /// <returns></returns>
        public UploadsApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="contentType">The content type of the file you upload. (optional)</param>
        /// <returns>CreateUploadDestinationResponse</returns>
        public CreateUploadDestinationResponse CreateUploadDestinationForResource (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null)
        {
             ApiResponse<CreateUploadDestinationResponse> localVarResponse = CreateUploadDestinationForResourceWithHttpInfo(marketplaceIdscontentMD5resourcecontentType);
        ...
        /// <param name="contentType">The content type of the file you upload. (optional)</param>
        /// <returns>ApiResponse of CreateUploadDestinationResponse</returns>
        public ApiResponse< CreateUploadDestinationResponse > CreateUploadDestinationForResourceWithHttpInfo (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null)
        {
        ...
        /// <param name="contentType">The content type of the file you upload. (optional)</param>
        /// <returns>Task of CreateUploadDestinationResponse</returns>
        public async System.Threading.Tasks.Task<CreateUploadDestinationResponse> CreateUploadDestinationForResourceAsync (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null)
        {
             ApiResponse<CreateUploadDestinationResponse> localVarResponse = await CreateUploadDestinationForResourceAsyncWithHttpInfo(marketplaceIdscontentMD5resourcecontentType);
             return localVarResponse.Data;
        ...
        /// <param name="contentType">The content type of the file you upload. (optional)</param>
        /// <returns>Task of ApiResponse (CreateUploadDestinationResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreateUploadDestinationResponse>> CreateUploadDestinationForResourceAsyncWithHttpInfo (List<string> marketplaceIdsstring contentMD5string resourcestring? contentType = null)
        {
            // verify the required parameter 'marketplaceIds' is set
            if (marketplaceIds == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceIds' when calling UploadsApi->CreateUploadDestinationForResource");
