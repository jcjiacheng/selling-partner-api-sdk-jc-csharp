...
namespace Amazon.SellingPartnerAPI.SDK.Api/sales/v1
{
    /// <summary>
    ...
    public interface ISalesApi : IApiAccessor
    {
        ...
        GetOrderMetricsResponse GetOrderMetrics (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null);
        ...
        ApiResponse<GetOrderMetricsResponse> GetOrderMetricsWithHttpInfo (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null);
        ...
        System.Threading.Tasks.Task<GetOrderMetricsResponse> GetOrderMetricsAsync (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetOrderMetricsResponse>> GetOrderMetricsAsyncWithHttpInfo (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null);
    ...
    public partial class SalesApi : ISalesApi
    {
        ...
        /// <returns></returns>
        public SalesApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="sku">Filters the results by the SKU that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all SKUs. Example: TestSKU, if you want the response to include order metrics for only SKU TestSKU. (optional)</param>
        /// <returns>GetOrderMetricsResponse</returns>
        public GetOrderMetricsResponse GetOrderMetrics (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null)
        {
             ApiResponse<GetOrderMetricsResponse> localVarResponse = GetOrderMetricsWithHttpInfo(marketplaceIdsintervalgranularitygranularityTimeZonebuyerTypefulfillmentNetworkfirstDayOfWeekasinsku);
        ...
        /// <param name="sku">Filters the results by the SKU that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all SKUs. Example: TestSKU, if you want the response to include order metrics for only SKU TestSKU. (optional)</param>
        /// <returns>ApiResponse of GetOrderMetricsResponse</returns>
        public ApiResponse< GetOrderMetricsResponse > GetOrderMetricsWithHttpInfo (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null)
        {
        ...
        /// <param name="sku">Filters the results by the SKU that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all SKUs. Example: TestSKU, if you want the response to include order metrics for only SKU TestSKU. (optional)</param>
        /// <returns>Task of GetOrderMetricsResponse</returns>
        public async System.Threading.Tasks.Task<GetOrderMetricsResponse> GetOrderMetricsAsync (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null)
        {
             ApiResponse<GetOrderMetricsResponse> localVarResponse = await GetOrderMetricsAsyncWithHttpInfo(marketplaceIdsintervalgranularitygranularityTimeZonebuyerTypefulfillmentNetworkfirstDayOfWeekasinsku);
             return localVarResponse.Data;
        ...
        /// <param name="sku">Filters the results by the SKU that you specify. Specifying both ASIN and SKU returns an error. Do not include this filter if you want the response to include order metrics for all SKUs. Example: TestSKU, if you want the response to include order metrics for only SKU TestSKU. (optional)</param>
        /// <returns>Task of ApiResponse (GetOrderMetricsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetOrderMetricsResponse>> GetOrderMetricsAsyncWithHttpInfo (List<string> marketplaceIdsstring intervalstring granularitystring? granularityTimeZone = nullstring? buyerType = nullstring? fulfillmentNetwork = nullstring? firstDayOfWeek = nullstring? asin = nullstring? sku = null)
        {
            // verify the required parameter 'marketplaceIds' is set
            if (marketplaceIds == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceIds' when calling SalesApi->GetOrderMetrics");
