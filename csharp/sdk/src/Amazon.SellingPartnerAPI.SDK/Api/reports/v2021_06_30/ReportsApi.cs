...
namespace Amazon.SellingPartnerAPI.SDK.Api/reports/v2021_06_30
{
    /// <summary>
    ...
    public interface IReportsApi : IApiAccessor
    {
        ...
        GetReportsResponse GetReports (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        ApiResponse<GetReportsResponse> GetReportsWithHttpInfo (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        System.Threading.Tasks.Task<GetReportsResponse> GetReportsAsync (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetReportsResponse>> GetReportsAsyncWithHttpInfo (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
    ...
    public partial class ReportsApi : IReportsApi
    {
        ...
        /// <returns></returns>
        public ReportsApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. &#x60;nextToken&#x60; is returned when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the &#x60;getReports&#x60; operation and include this token as the only parameter. Specifying &#x60;nextToken&#x60; with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>GetReportsResponse</returns>
        public GetReportsResponse GetReports (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
             ApiResponse<GetReportsResponse> localVarResponse = GetReportsWithHttpInfo(reportTypesprocessingStatusesmarketplaceIdspageSizecreatedSincecreatedUntilnextToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. &#x60;nextToken&#x60; is returned when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the &#x60;getReports&#x60; operation and include this token as the only parameter. Specifying &#x60;nextToken&#x60; with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>ApiResponse of GetReportsResponse</returns>
        public ApiResponse< GetReportsResponse > GetReportsWithHttpInfo (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. &#x60;nextToken&#x60; is returned when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the &#x60;getReports&#x60; operation and include this token as the only parameter. Specifying &#x60;nextToken&#x60; with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>Task of GetReportsResponse</returns>
        public async System.Threading.Tasks.Task<GetReportsResponse> GetReportsAsync (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
             ApiResponse<GetReportsResponse> localVarResponse = await GetReportsAsyncWithHttpInfo(reportTypesprocessingStatusesmarketplaceIdspageSizecreatedSincecreatedUntilnextToken);
             return localVarResponse.Data;
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. &#x60;nextToken&#x60; is returned when the number of results exceeds the specified &#x60;pageSize&#x60; value. To get the next page of results, call the &#x60;getReports&#x60; operation and include this token as the only parameter. Specifying &#x60;nextToken&#x60; with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>Task of ApiResponse (GetReportsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetReportsResponse>> GetReportsAsyncWithHttpInfo (List<string>? reportTypes = nullList<string>? processingStatuses = nullList<string>? marketplaceIds = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
