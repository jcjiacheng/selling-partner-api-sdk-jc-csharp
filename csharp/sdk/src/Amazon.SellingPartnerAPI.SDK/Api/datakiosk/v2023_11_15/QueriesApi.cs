...
namespace Amazon.SellingPartnerAPI.SDK.Api/datakiosk/v2023_11_15
{
    /// <summary>
    ...
    public interface IQueriesApi : IApiAccessor
    {
        ...
        GetQueriesResponse GetQueries (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null);
        ...
        ApiResponse<GetQueriesResponse> GetQueriesWithHttpInfo (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetQueriesResponse> GetQueriesAsync (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetQueriesResponse>> GetQueriesAsyncWithHttpInfo (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class QueriesApi : IQueriesApi
    {
        ...
        /// <returns></returns>
        public QueriesApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="paginationToken">A token to fetch a certain page of results when there are multiple pages of results available. The value of this token is fetched from the &#x60;pagination.nextToken&#x60; field returned in the &#x60;GetQueriesResponse&#x60; object. All other parameters must be provided with the same values that were provided with the request that generated this token, with the exception of &#x60;pageSize&#x60; which can be modified between calls to &#x60;getQueries&#x60;. In the absence of this token value, &#x60;getQueries&#x60; returns the first page of results. (optional)</param>
        /// <returns>GetQueriesResponse</returns>
        public GetQueriesResponse GetQueries (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null)
        {
             ApiResponse<GetQueriesResponse> localVarResponse = GetQueriesWithHttpInfo(processingStatusespageSizecreatedSincecreatedUntilpaginationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="paginationToken">A token to fetch a certain page of results when there are multiple pages of results available. The value of this token is fetched from the &#x60;pagination.nextToken&#x60; field returned in the &#x60;GetQueriesResponse&#x60; object. All other parameters must be provided with the same values that were provided with the request that generated this token, with the exception of &#x60;pageSize&#x60; which can be modified between calls to &#x60;getQueries&#x60;. In the absence of this token value, &#x60;getQueries&#x60; returns the first page of results. (optional)</param>
        /// <returns>ApiResponse of GetQueriesResponse</returns>
        public ApiResponse< GetQueriesResponse > GetQueriesWithHttpInfo (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null)
        {
        ...
        /// <param name="paginationToken">A token to fetch a certain page of results when there are multiple pages of results available. The value of this token is fetched from the &#x60;pagination.nextToken&#x60; field returned in the &#x60;GetQueriesResponse&#x60; object. All other parameters must be provided with the same values that were provided with the request that generated this token, with the exception of &#x60;pageSize&#x60; which can be modified between calls to &#x60;getQueries&#x60;. In the absence of this token value, &#x60;getQueries&#x60; returns the first page of results. (optional)</param>
        /// <returns>Task of GetQueriesResponse</returns>
        public async System.Threading.Tasks.Task<GetQueriesResponse> GetQueriesAsync (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null)
        {
             ApiResponse<GetQueriesResponse> localVarResponse = await GetQueriesAsyncWithHttpInfo(processingStatusespageSizecreatedSincecreatedUntilpaginationToken);
             return localVarResponse.Data;
        ...
        /// <param name="paginationToken">A token to fetch a certain page of results when there are multiple pages of results available. The value of this token is fetched from the &#x60;pagination.nextToken&#x60; field returned in the &#x60;GetQueriesResponse&#x60; object. All other parameters must be provided with the same values that were provided with the request that generated this token, with the exception of &#x60;pageSize&#x60; which can be modified between calls to &#x60;getQueries&#x60;. In the absence of this token value, &#x60;getQueries&#x60; returns the first page of results. (optional)</param>
        /// <returns>Task of ApiResponse (GetQueriesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetQueriesResponse>> GetQueriesAsyncWithHttpInfo (List<string>? processingStatuses = nullint? pageSize = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? paginationToken = null)
        {
