...
namespace Amazon.SellingPartnerAPI.SDK.Api/feeds/v2021_06_30
{
    /// <summary>
    ...
    public interface IFeedsApi : IApiAccessor
    {
        ...
        GetFeedsResponse GetFeeds (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        ApiResponse<GetFeedsResponse> GetFeedsWithHttpInfo (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        System.Threading.Tasks.Task<GetFeedsResponse> GetFeedsAsync (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetFeedsResponse>> GetFeedsAsyncWithHttpInfo (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null);
    ...
    public partial class FeedsApi : IFeedsApi
    {
        ...
        /// <returns></returns>
        public FeedsApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getFeeds operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>GetFeedsResponse</returns>
        public GetFeedsResponse GetFeeds (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
             ApiResponse<GetFeedsResponse> localVarResponse = GetFeedsWithHttpInfo(feedTypesmarketplaceIdspageSizeprocessingStatusescreatedSincecreatedUntilnextToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getFeeds operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>ApiResponse of GetFeedsResponse</returns>
        public ApiResponse< GetFeedsResponse > GetFeedsWithHttpInfo (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getFeeds operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>Task of GetFeedsResponse</returns>
        public async System.Threading.Tasks.Task<GetFeedsResponse> GetFeedsAsync (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
             ApiResponse<GetFeedsResponse> localVarResponse = await GetFeedsAsyncWithHttpInfo(feedTypesmarketplaceIdspageSizeprocessingStatusescreatedSincecreatedUntilnextToken);
             return localVarResponse.Data;
        ...
        /// <param name="nextToken">A string token returned in the response to your previous request. nextToken is returned when the number of results exceeds the specified pageSize value. To get the next page of results, call the getFeeds operation and include this token as the only parameter. Specifying nextToken with any other parameters will cause the request to fail. (optional)</param>
        /// <returns>Task of ApiResponse (GetFeedsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetFeedsResponse>> GetFeedsAsyncWithHttpInfo (List<string>? feedTypes = nullList<string>? marketplaceIds = nullint? pageSize = nullList<string>? processingStatuses = nullDateTime? createdSince = nullDateTime? createdUntil = nullstring? nextToken = null)
        {
