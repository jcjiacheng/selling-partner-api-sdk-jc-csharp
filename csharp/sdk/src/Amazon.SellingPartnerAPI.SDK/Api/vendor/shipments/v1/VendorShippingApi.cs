...
namespace Amazon.SellingPartnerAPI.SDK.Api/vendor/shipments/v1
{
    /// <summary>
    ...
    public interface IVendorShippingApi : IApiAccessor
    {
        ...
        GetShipmentDetailsResponse GetShipmentDetails (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null);
        ...
        ApiResponse<GetShipmentDetailsResponse> GetShipmentDetailsWithHttpInfo (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        GetShipmentLabels GetShipmentLabels (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null);
        ...
        ApiResponse<GetShipmentLabels> GetShipmentLabelsWithHttpInfo (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetShipmentDetailsResponse> GetShipmentDetailsAsync (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetShipmentDetailsResponse>> GetShipmentDetailsAsyncWithHttpInfo (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetShipmentLabels> GetShipmentLabelsAsync (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetShipmentLabels>> GetShipmentLabelsAsyncWithHttpInfo (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null);
        /// <summary>
        /// SubmitShipmentConfirmations
        /// </summary>
        /// <remarks>
    ...
    public partial class VendorShippingApi : IVendorShippingApi
    {
        ...
        /// <returns></returns>
        public VendorShippingApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="sellerWarehouseCode">Get Shipping Details based on vendor warehouse code. This value should be same as &#39;sellingParty.partyId&#39; in the Shipment. (optional)</param>
        /// <returns>GetShipmentDetailsResponse</returns>
        public GetShipmentDetailsResponse GetShipmentDetails (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null)
        {
             ApiResponse<GetShipmentDetailsResponse> localVarResponse = GetShipmentDetailsWithHttpInfo();
        ...
        /// <param name="sellerWarehouseCode">Get Shipping Details based on vendor warehouse code. This value should be same as &#39;sellingParty.partyId&#39; in the Shipment. (optional)</param>
        /// <returns>Task of GetShipmentDetailsResponse</returns>
        public async System.Threading.Tasks.Task<GetShipmentDetailsResponse> GetShipmentDetailsAsync (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? createdAfter = nullDateTime? createdBefore = nullDateTime? shipmentConfirmedBefore = nullDateTime? shipmentConfirmedAfter = nullDateTime? packageLabelCreatedBefore = nullDateTime? packageLabelCreatedAfter = nullDateTime? shippedBefore = nullDateTime? shippedAfter = nullDateTime? estimatedDeliveryBefore = nullDateTime? estimatedDeliveryAfter = nullDateTime? shipmentDeliveryBefore = nullDateTime? shipmentDeliveryAfter = nullDateTime? requestedPickUpBefore = nullDateTime? requestedPickUpAfter = nullDateTime? scheduledPickUpBefore = nullDateTime? scheduledPickUpAfter = nullstring? currentShipmentStatus = nullstring? vendorShipmentIdentifier = nullstring? buyerReferenceNumber = nullstring? buyerWarehouseCode = nullstring? sellerWarehouseCode = null)
        {
             ApiResponse<GetShipmentDetailsResponse> localVarResponse = await GetShipmentDetailsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <param name="sellerWarehouseCode">Get Shipping labels based on vendor warehouse code. This value must be same as the &#x60;sellingParty.partyId&#x60; in the shipment. (optional)</param>
        /// <returns>GetShipmentLabels</returns>
        public GetShipmentLabels GetShipmentLabels (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null)
        {
             ApiResponse<GetShipmentLabels> localVarResponse = GetShipmentLabelsWithHttpInfo(limitsortOrdernextTokenlabelCreatedAfterlabelCreatedBeforebuyerReferenceNumbervendorShipmentIdentifiersellerWarehouseCode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sellerWarehouseCode">Get Shipping labels based on vendor warehouse code. This value must be same as the &#x60;sellingParty.partyId&#x60; in the shipment. (optional)</param>
        /// <returns>ApiResponse of GetShipmentLabels</returns>
        public ApiResponse< GetShipmentLabels > GetShipmentLabelsWithHttpInfo (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null)
        {
        ...
        /// <param name="sellerWarehouseCode">Get Shipping labels based on vendor warehouse code. This value must be same as the &#x60;sellingParty.partyId&#x60; in the shipment. (optional)</param>
        /// <returns>Task of GetShipmentLabels</returns>
        public async System.Threading.Tasks.Task<GetShipmentLabels> GetShipmentLabelsAsync (long? limit = nullstring? sortOrder = nullstring? nextToken = nullDateTime? labelCreatedAfter = nullDateTime? labelCreatedBefore = nullstring? buyerReferenceNumber = nullstring? vendorShipmentIdentifier = nullstring? sellerWarehouseCode = null)
        {
             ApiResponse<GetShipmentLabels> localVarResponse = await GetShipmentLabelsAsyncWithHttpInfo(limitsortOrdernextTokenlabelCreatedAfterlabelCreatedBeforebuyerReferenceNumbervendorShipmentIdentifiersellerWarehouseCode);
             return localVarResponse.Data;
