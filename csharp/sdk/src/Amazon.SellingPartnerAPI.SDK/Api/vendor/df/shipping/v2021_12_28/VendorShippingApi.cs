...
namespace Amazon.SellingPartnerAPI.SDK.Api/vendor/df/shipping/v2021_12_28
{
    ...
    public interface IVendorShippingApi : IApiAccessor
    {
        ...
        PackingSlipList GetPackingSlips (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null);
        ...
        ApiResponse<PackingSlipList> GetPackingSlipsWithHttpInfo (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<PackingSlipList> GetPackingSlipsAsync (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<PackingSlipList>> GetPackingSlipsAsyncWithHttpInfo (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null);
        /// <summary>
        /// submitShipmentConfirmations
        /// </summary>
        /// <remarks>
    ...
    public partial class VendorShippingApi : IVendorShippingApi
    {
        ...
        /// <param name="nextToken">Used for pagination when there are more packing slips than the specified result size limit. The token value is returned in the previous API call. (optional)</param>
        /// <returns>PackingSlipList</returns>
        public PackingSlipList GetPackingSlips (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null)
        {
             ApiResponse<PackingSlipList> localVarResponse = GetPackingSlipsWithHttpInfo(createdAftercreatedBeforeshipFromPartyIdlimitsortOrdernextToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="nextToken">Used for pagination when there are more packing slips than the specified result size limit. The token value is returned in the previous API call. (optional)</param>
        /// <returns>ApiResponse of PackingSlipList</returns>
        public ApiResponse< PackingSlipList > GetPackingSlipsWithHttpInfo (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null)
        {
        ...
        /// <param name="nextToken">Used for pagination when there are more packing slips than the specified result size limit. The token value is returned in the previous API call. (optional)</param>
        /// <returns>Task of PackingSlipList</returns>
        public async System.Threading.Tasks.Task<PackingSlipList> GetPackingSlipsAsync (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null)
        {
             ApiResponse<PackingSlipList> localVarResponse = await GetPackingSlipsAsyncWithHttpInfo(createdAftercreatedBeforeshipFromPartyIdlimitsortOrdernextToken);
             return localVarResponse.Data;
        ...
        /// <param name="nextToken">Used for pagination when there are more packing slips than the specified result size limit. The token value is returned in the previous API call. (optional)</param>
        /// <returns>Task of ApiResponse (PackingSlipList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PackingSlipList>> GetPackingSlipsAsyncWithHttpInfo (DateTime createdAfterDateTime createdBeforestring? shipFromPartyId = nullint? limit = nullstring? sortOrder = nullstring? nextToken = null)
        {
            // verify the required parameter 'createdAfter' is set
            if (createdAfter == null)
                throw new ApiException(400, "Missing required parameter 'createdAfter' when calling VendorShippingApi->GetPackingSlips");
