...
namespace Amazon.SellingPartnerAPI.SDK.Api/appIntegrations/v2024_04_01
{
    /// <summary>
    ...
    public interface IAppIntegrationsApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void RecordActionFeedback (string notificationIdRecordActionFeedbackRequest body);
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> RecordActionFeedbackWithHttpInfo (string notificationIdRecordActionFeedbackRequest body);
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task RecordActionFeedbackAsync (string notificationIdRecordActionFeedbackRequest body);
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> RecordActionFeedbackAsyncWithHttpInfo (string notificationIdRecordActionFeedbackRequest body);
    ...
    public partial class AppIntegrationsApi : IAppIntegrationsApi
    {
        ...
        /// <returns></returns>
        public AppIntegrationsApi(Amazon.SellingPartnerAPI.SDK.Client.Configuration configuration)
        {
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns></returns>
        public void RecordActionFeedback (string notificationIdRecordActionFeedbackRequest body)
        {
             RecordActionFeedbackWithHttpInfo(notificationIdbody);
        }
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> RecordActionFeedbackWithHttpInfo (string notificationIdRecordActionFeedbackRequest body)
        {
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RecordActionFeedbackAsync (string notificationIdRecordActionFeedbackRequest body)
        {
             await RecordActionFeedbackAsyncWithHttpInfo(notificationIdbody);
        ...
        /// <param name="body">The request body for the &#x60;recordActionFeedback&#x60; operation.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> RecordActionFeedbackAsyncWithHttpInfo (string notificationIdRecordActionFeedbackRequest body)
        {
            // verify the required parameter 'notificationId' is set
            if (notificationId == null)
                throw new ApiException(400, "Missing required parameter 'notificationId' when calling AppIntegrationsApi->RecordActionFeedback");
