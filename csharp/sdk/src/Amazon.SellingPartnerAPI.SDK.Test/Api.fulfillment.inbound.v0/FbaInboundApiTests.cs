...
using Amazon.SellingPartnerAPI.SDK.Api.fulfillment.inbound.v0;
using Amazon.SellingPartnerAPI.SDK.Model.fulfillment.inbound.v0;

namespace Amazon.SellingPartnerAPI.SDK.Api.fulfillment.inbound.v0.Model.fulfillment.inbound.v0.Test
{
    /// <summary>
