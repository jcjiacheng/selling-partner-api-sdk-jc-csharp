# Amazon.SellingPartnerAPI.SDK - the C# library for the The Selling Partner API for Automotive.
...
```
nuget pack -Build -OutputDirectory out Amazon.SellingPartnerAPI.SDK.csproj
```
